  ...
  <div class="property">
    ...
    <template v-if="!this.notFound && !this.hasEnded">
      <el-row
        ...
        style="
          ...
          box-shadow: inset 0px 15px 20px -15px rgba(70, 92, 132, 0.45);
        "
      >
        <el-col
          :span="16"
          style="margin: 0 50px 20px 30px; border: 1px solid #ccc"
        >
          <el-row
            style="
          ...
          >
            <el-col style="padding: 20px 20px 0 0">
              <h3 style="margin: 0 0 0 20px">
                <i class="el-icon-location"></i> {{ propInfo.address }}
              </h3>
            </el-col>
            <el-row style="margin-left: 30px; margin-bottom: 10px">
              <span style="font-size: 15px"
                >{{ this.showTime2(propInfo.startdate) }} to
                {{ this.showTime2(propInfo.enddate) }}</span
              >
            </el-row>
          </el-row>
          ...
          <section style="margin: 0 50px 0 50px">
            ...
            <el-row class="banner" :class="addStatusColor(propInfo.status)">
              <h5 style="padding: 5px">
                ...
                <span v-if="propInfo.status === 'A'" style="font-size: 15px"
                  >Time Left
                </span>
                {{ time }}
              </h5>
          ...
          <el-row type="flex" justify="center" style="margin: 15px 50px 0 50px">
            ...
            <el-col :span="12">
              <div class="bidder">
                {{ propInfo.bidderNum }}
                <span style="font-size: 15px">Bidders</span>
              </div>
            </el-col>
          </el-row>
              ...
              <el-col>
                ...
                <el-row type="flex" justify="left" style="margin-bottom: 10px">
                  ...
                  <el-col class="tag-wrap2" :span="4">
                    ...
                    <span>
                      {{ propInfo.bathroomNum }}
                      <span style="font-size: 15px">Baths</span>
                    </span>
                  </el-col>
                  <el-col class="tag-wrap2" :span="4">
                    ...
                    <span>
                      {{ propInfo.bedroomNum }}
                      <span style="font-size: 15px">Beds</span></span
                    >
                  </el-col>
                  ...
                  <el-col class="tag-wrap2" :span="4">
                    ...
                    <span>
                      {{ propInfo.garageNum }}
                      <span style="font-size: 15px">Garages</span></span
                    >
                  </el-col>
                  ...
                  <el-col class="tag-wrap2" :span="4">
                    ...
                    <span>
                      {{ propInfo.area }}
                      <span style="font-size: 15px">m2</span></span
                    >
                  </el-col>
          ...
          <section
            v-show="propInfo.status === 'A'"
            style="margin: 0 50px 0 50px; height: 400px"
          >
            <h3><i class="el-icon-paperclip"></i> Bid History</h3>

            <el-table
              :data="propInfo.history"
              :max-height="300"
              border
              lazy
              stripe
          ...
          <div class="info">
            ...
            <el-row type="flex" justify="center" style="margin-top: 20px">
              <i class="el-icon-user-solid"
                ><span> {{ propInfo.username }} </span></i
              >
            </el-row>

            <el-row type="flex" justify="center" style="margin-top: 20px">
              <i class="el-icon-phone"
                ><span> {{ propInfo.phone }} </span></i
              >
            </el-row>

            <el-row type="flex" justify="center" style="margin-top: 20px">
              <i class="el-icon-message"
                ><span> {{ propInfo.email }} </span></i
              >
            </el-row>
          </div>
          ...
          <template v-if="this.username !== null">
            <template v-if="username !== propInfo.username">
              ...
              >
                <h5
                  style="
                    background-color: rgba(30, 45, 98, 0.66);
                    height: 50px;
                    padding: 15px;
                    color: white;
                  "
                >
                  <i class="el-icon-s-finance"></i> Place New Bid Here
                </h5>
                <el-row
                  v-show="propInfo.status === 'A'"
                  type="flex"
                  justify="center"
                >
                  <span style="color: rgba(37, 61, 114, 0.61); font-size: 15px"
                    >Your Current Bid
                  </span>
                </el-row>
                <el-row
                ...
                >
                  <span style="font-weight: bold">
                    ${{ propInfo.highestPrice | numFormat }}</span
                  >
                </el-row>
                  ...
                  >
                    <el-col :span="21">
                      <el-form-item prop="newBid">
                        <el-input
                          v-model="bidform.newBid"
                          :disabled="this.propInfo.status === 'R'"
                          maxlength="10"
                          placeholder="Bid Price"
                        >
                          <i slot="suffix" class="input-slot"
                            >{{ bidform.newBid | numFormat }} A$</i
                          >
                        </el-input>
                      </el-form-item>
                    </el-col>
                ...
                <el-row style="margin-top: 0">
                  <p style="font-size: 10px">
                    <i class="el-icon-info"></i> New bid price should larger
                    than the latest bid price.
                  </p>
                </el-row>
              </div>
          ...
          <div id="test-page" :class="{ 'p-fixed': searchBarFixed }">
            ...
            <el-row type="flex" justify="center">
              <div style="width: 400px">
                <el-col
                  v-for="item in propInfo.recommendations"
                  :key="item.aid"
                >
            ...
            <el-tabs v-model="activateIndex" :tab-position="'left'">
                ...
                <el-row v-show="!addNewCard" type="flex" justify="center">
                  <el-col :span="15">
                    ...
                    <el-row>
                      <div class="btns3">
                        <el-col class="el-radio" style="height: 40px">
                          <span class="add-btn" @click="checktable1">
                            <div style="margin: 12px 0; text-align: center">
                              <i class="el-icon-plus"> </i> Add New Card
                            </div>
                          </span>
                        </el-col>
                      </div>
                    ...
                    <el-row>
                      <div class="btns2">
                        <el-col>
                          <span style="padding: 2px 5px" @click="checktable2"
                            ><i class="el-icon-right"></i> Next</span
                          >
                        </el-col>
                      </div>
                    </el-row>
                ...
                <el-row v-show="addNewCard" type="flex" justify="center">
                  <el-col>
                    ...
                    >
                      ...
                      <el-row>
                        <div class="btns2">
                          <span style="padding: 2px 5px" @click="checktable3"
                            ><i class="el-icon-plus"></i> Add</span
                          >
                        </div>

                        <div class="btns2">
                          <span style="padding: 2px 5px" @click="checktable4"
                            ><i class="el-icon-back"></i> Back</span
                          >
                        </div>
                      </el-row>
                    </el-form>
              ...
              <el-tab-pane label="Submit" name="2">
                <el-col :span="20">
                  <el-row type="flex" justify="center">
                    ...
                    >
                      <el-form-item prop="initPrice">
                        ...
                        <el-input
                          v-model="form3.initPrice"
                          maxlength="11"
                          placeholder="Initial Price"
                        ></el-input>
                        <p>
                          Your initial bid is ${{
                            form3.initPrice | numFormat
                          }}.
                        </p>
                      </el-form-item>
                    </el-form>
                  ...
                  <el-row>
                    <div class="btns2">
                      <span style="padding: 2px 5px" @click="submitCard"
    ...
    <template v-if="this.notFound && !this.hasEnded">
      <div>
        ...
        <el-row type="flex" justify="center">
          <span style="font-size: 20px; color: rgba(89, 108, 132, 0.88)"
            >Oops..This auction can not be found.</span
          >
        </el-row>
      </div>
    </template>
    ...
    <template v-if="this.hasEnded">
      <div>
        ...
        <el-row type="flex" justify="center">
          <span style="font-size: 20px; color: rgba(89, 108, 132, 0.88)"
            >Oops..This auction has ended.</span
          >
        </el-row>
      </div>
    </template>
    ...
    return {
      ...
      rules: {
        initPrice: [
          {
            required: true,
            message: " Please enter init price",
            trigger: "blur",
          },
        ...
        cvc: [
          ...
          { validator: checkCVC, trigger: "blur" },
        ],
        // initPrice: [{required: true, message: " Please initial price", trigger: "blur",},{validator:checkinit, trigger: "blur" }],
        newBid: [
          {
            required: true,
            message: " Please enter new bid price",
            trigger: "blur",
          },
          { validator: checkNewBid, trigger: "blur" },
        ],
      },
    };
  },
              ...
              .then((response) => {
                if (response.status >= 200 && response.status < 300) {
                  if (response.data.code === 200) {
                    ...
                    // location.reload();
                    this.propInfo.highestPrice = this.form3.initPrice.replace(
                      /,/g,
                      ""
                    );
                  }
