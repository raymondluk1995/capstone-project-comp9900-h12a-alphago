<template>
  <div class="property">
    ...
    <el-row type="flex" justify="center">
      <el-col
        :span="16"
        style="margin: 50px 50px 20px 30px; box-shadow: 2px 1px 5px 4px #d5dbea"
      >
        ...
        >
            ...
            <el-row>
              <el-radio-group v-model="selectCard">
                <el-radio
                  ...
                  :disabled="addNewCard"
                  v-for="item in cards"
                  style="display: block; margin: 20px 50px"
                  >{{ item }}</el-radio
                >
              </el-radio-group>
            </el-row>
          ...
          <template v-show="addNewCard">
            ...
            >
              ...
              <el-row>
                <el-link icon="el-icon-top" type="primary" @click="notAdd"
                  >Cancel</el-link
                >
              </el-row>
            </el-form>
            ...
            <el-col>
              ...
              <el-row type="flex" style="margin-bottom: 10px">
                <i class="el-icon-toilet-paper">
                  Bathroom Number: <span> {{ propInfo.bathroomNum }} </span></i
                >
              </el-row>

              <el-row type="flex" style="margin-bottom: 10px">
                <i class="el-icon-house">
                  Bedroom Number: <span> {{ propInfo.bedroomNum }} </span></i
                >
              </el-row>

              <el-row type="flex" style="margin-bottom: 10px">
                <i class="el-icon-truck">
                  Garage Number: <span> {{ propInfo.garageNum }} </span></i
                >
              </el-row>
              ...
              <el-row type="flex" style="margin-bottom: 10px">
                <el-tag
                  v-for="tag in propInfo.position.split(',')"
                  effect="plain"
                  :key="propInfo.position"
                  >{{ tag }}</el-tag
                >
              </el-row>
              ...
              <el-row type="flex" style="margin-bottom: 10px">
                <el-tag
                  v-for="tag in propInfo.detail.split(',')"
                  :key="propInfo.detail"
                  >{{ tag }}</el-tag
                >
              </el-row>
        ...
        >
          ...
          <el-table :data="propInfo.bidHistory" stripe style="width: 100%">
            <el-table-column prop="time" label="Time" width="300px">
            </el-table-column>
            <el-table-column prop="user" label="User" width="300px">
            </el-table-column>
            <el-table-column prop="price" label="Bid Price"> </el-table-column>
          </el-table>
        </section>
      </el-col>
      <el-col :span="5">
        ...
        <template v-if="username !== propInfo.username">
          ...
          <div v-else style="margin-top: 2px">
            <el-button type="" class="btn" @click="Bidreg" icon="el-icon-right"
...
export default {
  ...
  created() {
    ...
    this.propInfo.bidHistory.push({
      time: new Date(2009, 1, 1, 1, 1, 1),
      user: "aaa",
      price: "$123123123",
    });
    this.$title = this.propInfo.address;
  },
