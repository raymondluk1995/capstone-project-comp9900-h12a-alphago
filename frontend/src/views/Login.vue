  ...
  <div class="login">
    ...
    <el-row type="flex" justify="center">
      ...
      <el-col :span="9">
        <div id="container">
          <div class="btn-style">
            <span v-if="!loginByuser" id="btn-move1" @click="byuser"
              >Login By Username<i class="el-icon-right el-icon--right"></i
            ></span>
            <span v-else id="btn-move2" @click="byemail"
              >Login By Email<i class="el-icon-right el-icon--right"></i
            ></span>
            <div class="bottom-line"></div>
          </div>

          <div class="content">
            <el-form class="details" ref="form" :model="form" :rules="rules">
              ...
              <div class="item" style="margin-top: 40px">
                ...
                <span
                  ...
                  @click="forgetpwd"
                  :style="active2"
                  ><i class="el-icon-warning-outline"></i> Forget
                  Password?</span
                >
...
export default {
  ...
  methods: {
    ...
    mouseOver1() {
      this.active1 = "border-left:3px solid #123123;";
    },
    mouseLeave1() {
      this.active1 = "";
    },
    ...
    mouseOver2() {
      this.active2 = "border-left:3px solid #123123;";
    },
    mouseLeave2() {
      this.active2 = "";
    },
    ...
    mouseOver3() {
      this.active3 = "border-left:3px solid #123123;";
    },
    mouseLeave3() {
      this.active3 = "";
    },
