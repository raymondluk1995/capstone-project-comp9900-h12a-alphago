          ...
          <el-row :gutter="50">
            <el-col :span="14">
              ...
              <el-form-item v-else label="Email:" prop="email">
                ...
                <el-button
                  round
                  style="width: 25%; float: right; margin-top: 10px"
                  type="info"
                  @click="validate"
                  v-show="show"
                  >Validate</el-button
              ...
              <el-form-item
                v-if="!canEditFirstname"
                label="First Name:"
                prop="firstname"
              >
                <el-input
                  style="width: 70%; float: left"
                  v-model="form.ofirstname"
              ...
              <el-form-item
                v-if="!canEditLastname"
                label="Last Name:"
                prop="lastname"
              >
                <el-input
                  style="width: 70%; float: left"
                  v-model="form.olastname"
    ...
    submitE() {
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          this.$axios
            .post("/user/information/changeEmail", data)
            .then((response) => {
    ...
    submitL() {
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          this.$axios
            .post("/user/information/changeLastname", data)
            .then((response) => {
              if (response.status >= 200 && response.status < 300) {
                if (response.data.code === 200) {
    ...
    submitF() {
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          this.$axios
            .post("/user/information/changeFirstname", data)
            .then((response) => {
              if (response.status >= 200 && response.status < 300) {
                if (response.data.code === 200) {
    ...
    submitA() {
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          this.$axios
            .post("/user/information/changeAvatar", data)
            .then((response) => {
              if (response.status >= 200 && response.status < 300) {
                if (response.data.code === 200) {
