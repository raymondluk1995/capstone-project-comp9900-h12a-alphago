    ...
    <div id="main" justify="center">
      ...
      <template v-if="!isEmpty">
        <el-row type="flex" justify="center" class="result-rows">
          <el-col
            :span="16"
            style="margin: 0 50px 20px 30px; border-right: 1px solid #ccc"
          >
            <div class="items">
              <ul :class="colNumObject">
                <li v-for="item in propList" :key="item.aid">
                  ...
                  >
                    ...
                    <v-img height="250" :src="item.photos[0]"></v-img>
    ...
    return {
      ...
      propList: [
        ...
        },
        {
          ...
          area: 123,
          address:
            "2 Gearin Alley, Mascot, NSW 2 Gearin Alley, Mascot, NSW 2 Gearin Alley, Mascot, NSW",
          photos: [
            "data:image/jpeg;base64,",
            "data:image/jpeg;base64,",
          ],
    ...
    toSearch() {
      ...
      this.$axios
        ...
        .then((res) => {
          ...
          this.recommendations = res.data.result.recommendations;
