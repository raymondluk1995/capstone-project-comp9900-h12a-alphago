              ...
              <li>
                <v-card class="mx-auto my-12" max-width="600">
                  ...
                  <v-card-text>
                    ...
                    <div class="my-4 subtitle-1 result-type">Type: {{ item.type }}</div>
                  </v-card-text>

                  <v-divider class="mx-4" style="margin:0; padding:0"></v-divider>
                  <v-card-text style="padding:5px;margin:0">
                    <el-row type="flex" justify="space-around" class="current-price">
                      <div class="bid">
                        Current Bid: <br>
